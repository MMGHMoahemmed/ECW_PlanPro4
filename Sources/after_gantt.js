...
//filters on headers start
    ...
    const columnTypes = {
        number: ["wbs","duration", "progress", "Cost_Dollar", "Cost_Yemeni", "Allocated_budget", "Spent", "The_Balance", "Precentage", "Jan_FC", "Feb_FC", "Mar_FC", "Apr_FC", "May_FC", "Jun_FC", "Jul_FC", "Aug_FC", "Sep_FC", "Oct_FC", "Nov_FC", "Dec_FC", "Total", "final_remaining", "Period_Target", "Period_Actual", "Period_Precentage_of_Target"
        ],
    ...
    const filterTypes = {
        number: `
          <div class="filter_element"><label>Min:</label><input type="number" placeholder="0" min="0" class="filter_min"></div>
          <div class="filter_element"><label>Max:</label><input type="number" placeholder="9999" min="0" class="filter_max"></div>
        `,
        string: `
          <div class="filter_element"><label>Match:</label><input type="text" placeholder="type the text here" class="filter_match"></div>
        `,
        date: `
          <div class="filter_element"><label>Min:</label><input type="date" class="filter_range_min"></div>
          <div class="filter_element"><label>Max:</label><input type="date" class="filter_range_max"></div>
        `,
    }
    ...
    function getFilterBoxType(columnName) {
        if (columnName === 'text') {
            return `
                 <div class="filter_element"><label>Match Task:</label><input type="text" placeholder="type the text here" class="filter_match_with_children"></div>
                <div class="filter_element"><label>Match Task Including Children:</label><input type="text" placeholder="type the text here" class="filter_match"></div>
    ...
    function showFilterBox(columnName, e) {
        ...
        el.innerHTML = `
          <div class="filter_header">
            <span>Filter by <b>${columnLabel}</b></span>
            <button class="hide_filter" onclick="hideFilterBox()">&times;</button>
          </div>
          <div class="filter_body">
            ${getFilterBoxType(columnName)}
          </div>
          <div class="filter_footer">
            <button class="remove_filter">Reset</button>
          </div>
        `
...
function firebaseConfigInfo(){
    var firebaseConfig = {
  apiKey: "AIzaSyCWk0lMGXEorjKGFKCQdTl0zeuWW7ahEps",
  authDomain: "ecwnmo.firebaseapp.com",
  databaseURL: "https://ecwnmo-default-rtdb.firebaseio.com",
  projectId: "ecwnmo",
  storageBucket: "ecwnmo.firebasestorage.app",
  messagingSenderId: "761450479043",
  appId: "1:761450479043:web:a63922e822d84e4d1c1176",
  measurementId: "G-3G9DZD0RRL"
    };
